...
namespace LinqExercises.Controllers
{
    public class OrdersController : ApiController
    {
        ...
        {
            //"Write a query to return all orders with required dates 
            //between Jan 1, 1997 and Dec 31, 1997 with freight under 100 units.");
        ...
        public IHttpActionResult PurchaseReport()
        {
            ...
            // A Product property and the quantity ordered for that product labelled as 'QuantityPurchased' 
            //ordered by QuantityPurchased in descending order.");
            var anonObject = from p in _db.Order_Details
