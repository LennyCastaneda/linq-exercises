...
namespace LinqExercises.Controllers
{
    public class ShippersController : ApiController
    {
        ...
        public IHttpActionResult GetFreightReport()
        {
            ...
            //A Shipper property and the freight totals for that shipper labelled as 'FreightTotals' 
            // rounded to the nearest whole number from the Orders table, ordered by FreightTotals in descending order.");
            // decimal sumLineTotal = orderdetailscollection.Sum(od => od.LineTotal);
            //var shipProp = from o in _db.Orders
                           //select new { o.Shipper.CompanyName, o.
        }
